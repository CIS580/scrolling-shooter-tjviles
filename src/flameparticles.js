...
/**
 * @module FlameParticles
 * A class for managing a particle engine that
 * emulates a smoke trail
 */
module.exports = exports = FlameParticles;

/**
 * @constructor FlameParticles
 * Creates a FlameParticles engine of the specified size
 * @param {uint} size the maximum number of particles to exist concurrently
 */
function FlameParticles(maxSize) {
...
*/
FlameParticles.prototype.emit = function(position) {
 ...
 */
FlameParticles.prototype.update = function(elapsedTime) {
...
/**
 * @function render
 * Renders all particles in our array.
 * @param {DOMHighResTimeStamp} elapsedTime
 * @param {CanvasRenderingContext2D} ctx
 */
FlameParticles.prototype.render = function(elapsedTime, ctx) {
  function renderParticle(i){
    ...
    ctx.fillStyle = 'rgba(236, 28, 28,' + alpha + ')';
    ctx.fill();
  }
